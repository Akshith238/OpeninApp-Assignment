...
const Navbar = ({content,profile,setToggle,toggle}) => {
  return (
    <div className='flex justify-between bg-white lg:bg-transparent w-[360px] lg:m-3 h-[80px] lg:w-[1200px] items-center gap-3 p-3 lg:p-4 lg:gap-4'>
        <button onClick={()=>setToggle(true)}className='flex lg:hidden'>
          <svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1 1H17M1 13H17M1 7H17" stroke="#231F20" stroke-width="1.5" stroke-linecap="round"/>
          </svg>
        </button>
        <div className='hidden lg:flex w-[1052px] text-[24px] items-center font-nunito font-semibold text-2xl leading-8 text-black'>
