...
const SignIn = () => {
  ...
  return (
    <div>
        <div class="absolute w-[143.81px] h-[48.3px] left-[813.18px] top-[235.32px] font-sans font-bold text-2xl leading-11 text-black">
            Sign In
        </div>
        <div class="absolute w-[176.74px] h-[20.86px] left-[813.18px] top-[270.11px] font-lato font-normal text-base leading-5 text-black">
            Sign in to your account
        </div>
        <button onClick={handleSignInClick} class="absolute w-[200.6px] h-[32.93px] left-[813.18px] top-[310.51px] bg-white rounded-lg flex gap-3 items-center justify-center">
        ...
        <button onClick={handleSignInClick} class="absolute w-[200.6px] h-[32.93px] left-[1040px] top-[310.51px] bg-white rounded-lg flex gap-3 items-center justify-center">
            <span class="w-[15.37px] h-[15.37px]">
        ...
        <SignInForm/>
        <div class="absolute w-[286.51px] h-[20.86px] left-[881.24px] top-[768.83px] font-lato font-normal text-base text-center text-gray-500">
